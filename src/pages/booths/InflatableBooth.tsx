...
import { Check, ArrowLeft, Tent, Lightbulb, Lock, Music } from 'lucide-react';

const features = [
  { icon: Tent, title: 'Enclosed Design', description: 'Private photo experience' },
  { icon: Lightbulb, title: 'LED Lighting', description: 'Colorful ambient lighting' },
  { icon: Lock, title: 'Privacy Curtain', description: 'Complete privacy for guests' },
  { icon: Music, title: 'Festival Ready', description: 'Perfect for outdoor events' },
];
        ...
        <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 bg-primary text-primary-foreground overflow-hidden">
          ...
          <div className="section-container relative">
            ...
            <p className="text-xl text-white/80 leading-relaxed max-w-2xl">
              Fun enclosed inflatable booth creating a private photo experience. Great for parties and festivals where you want that classic booth feel.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-primary text-primary-foreground">
          <div className="section-container text-center">
            ...
            <p className="text-white/80 mb-8 max-w-xl mx-auto">
              Bring the fun with our Inflatable Enclosed Booth. Contact us today for availability.
            </p>
