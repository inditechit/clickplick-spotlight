...
import { Check, ArrowLeft, Camera, Smartphone, Printer, Sparkles } from 'lucide-react';

const features = [
  { icon: Camera, title: 'DSLR Camera', description: 'Professional quality photos every time' },
  { icon: Smartphone, title: 'Digital Sharing', description: 'Instant share to social media' },
  { icon: Printer, title: 'Instant Prints', description: 'Unlimited high-quality prints' },
  { icon: Sparkles, title: 'Custom Overlays', description: 'Personalized designs for your event' },
];
        ...
        <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 bg-primary text-primary-foreground overflow-hidden">
          ...
          <div className="section-container relative">
            ...
            <p className="text-xl text-white/80 leading-relaxed max-w-2xl">
              Our most popular booth! Sleek, modern design with a stunning LCD touchscreen interface. Perfect for any venue and event type.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-primary text-primary-foreground">
          <div className="section-container text-center">
            ...
            <p className="text-white/80 mb-8 max-w-xl mx-auto">
              Make your event unforgettable with our LCD Screen Slimline Pod. Contact us today for availability.
            </p>
